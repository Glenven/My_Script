...
function PostRequest(_0x4ec510, _0x2926e5) {
    ...
    const _0x23584b = {
        'Accept': _0x3f625e['Accept'],
        'Accept-Encoding': 'gzip, deflate, br',
        'Accept-Language': _0x3f625e['Accept-Language'],
        'Connection': 'keep-alive',
        'Content-Type': _0x3f625e['Content-Type'],
        'Cookie': cookie,
        'Host': _0x3f625e['Host'],
...
function PostRequests(_0x46282a, _0x26f060) {
    ...
    const _0x5cbe1f = {
        'Accept': _0x57444b['Accept'],
        'Accept-Encoding': _0x57444b['Accept-Encoding'],
        'Accept-Language': _0x57444b['Accept-Language'],
        'Cookie': cookie,
        'Host': _0x57444b['Host'],
        'User-Agent': _0x57444b['User-Agent']
    };
    return {
        'url': _0x590e0d,
        'method': _0x46a8a8,
