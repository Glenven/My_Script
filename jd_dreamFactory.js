...
const inviteCodes = [
  '5-GjPFJV15nhSfpjpLJzKA==@gV-7J2uqM-upAiWTcVGEkw==@6wYEvTsb9RVq-5WJfGcGog==@Tn4iXnN2DRQAUFJB5_RqMQ==@jXJfNX725I4AMNW38U2AGg==',
  '5-GjPFJV15nhSfpjpLJzKA==@gV-7J2uqM-upAiWTcVGEkw==@6wYEvTsb9RVq-5WJfGcGog==@Tn4iXnN2DRQAUFJB5_RqMQ==@jXJfNX725I4AMNW38U2AGg==',
  '5-GjPFJV15nhSfpjpLJzKA==@gV-7J2uqM-upAiWTcVGEkw==@6wYEvTsb9RVq-5WJfGcGog==@Tn4iXnN2DRQAUFJB5_RqMQ==@jXJfNX725I4AMNW38U2AGg==',
  '5-GjPFJV15nhSfpjpLJzKA==@gV-7J2uqM-upAiWTcVGEkw==@6wYEvTsb9RVq-5WJfGcGog==@Tn4iXnN2DRQAUFJB5_RqMQ==@jXJfNX725I4AMNW38U2AGg==',
];
...
//   $.tuanIdS = null;
//   if (!$.tuanIdS) await updateTuanIdsCDN('https://gitee.com/h455257166/MyUpdateTeam/raw/main/shareCodes/jd_updateFactoryTuanId.json');
...
// }
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN(), res2 = await updateTuanIdsCDN("https://gitee.com/h455257166/MyUpdateTeam/raw/main/shareCodes/jd_updateFactoryTuanId.json")
  if (!res) res = await updateTuanIdsCDN('https://gitee.com/h455257166/MyUpdateTeam/raw/main/shareCodes/jd_updateFactoryTuanId.json');
...
function updateTuanIdsCDN(url = 'https://raw.githubusercontent.com/h455257166/MyUpdateTeam/main/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    const options = {
...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    if ($.tuanConfigs && $.tuanConfigs['tuanActiveId']) {
      ...
      if (!$.tuanConfigs) {
        await updateTuanIdsCDN('https://gitee.com/h455257166/MyUpdateTeam/raw/main/shareCodes/jd_updateFactoryTuanId.json');
        if ($.tuanConfigs && $.tuanConfigs['tuanActiveId']) {
          tuanActiveId = $.tuanConfigs['tuanActiveId'];
          console.log(`拼团活动ID: 获取成功 ${tuanActiveId}`)
        } else {
