...
==============Loon==============
[Script]
cron "4 10 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jx_lhb.js,tag=京喜领88元红包
 ...
 *JSDec - JSDec.js.org
 */
function taskurl(_0x10552c, body = '', _0x53d809) {
    var _0x195ffb = {
    ...
    let _0x19d082 = BASE_URL + '/' + _0x10552c + '?activeId=' + $.activeId + '&publishFlag=1&channel=7&' + body + '&sceneval=2&g_login_type=1&timestamp=' + Date['now']() + '&_=' + (Date['now']() + 0x2) + '&_ste=1';
