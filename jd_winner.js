...
[task_local]
#发财大赢家-翻翻乐
20 9-23/3 * * * jd_winner.js, tag=发财大赢家-翻翻乐, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "20 9-23/3 * * *" script-path=jd_winner.js,tag=发财大赢家-翻翻乐

===============Surge=================
发财大赢家-翻翻乐 = type=cron,cronexp="20 9-23/3 * * *",wake-system=1,timeout=3600,script-path=jd_winner.js

============小火箭=========
发财大赢家-翻翻乐 = type=cron,script-path=jd_winner.js, cronexpr="20 9-23/3 * * *", timeout=3600, enable=true
 */
