...
var _0xod1 = 'jsjiami.com.v6',
    _0x38f3 = [_0xod1, 'get', 'https://raw.fastgit.org/zero205/updateTeam/main/shareCodes/dyj.json', 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88', 'log', 'stringify', 'name', ' API请求失败，请检查网路重试', 'authorCode', 'parse', 'wait', 'getHours', 'length', 'UserName', 'match', 'index', 'isLogin', '\x0a【京东账号', ' 去助力【zero205】', 'redEnvelopeId', 'inviter', 'helptype', 'logErr', 'CjsjBiamirNkxCzP.KcDom.v6rZRX=='];
var _0x1f57 = function(_0x59ebe7, _0x5c1318) {
    _0x59ebe7 = ~~'0x' ['concat'](_0x59ebe7);
    var _0x1c0dc4 = _0x38f3[_0x59ebe7];
    return _0x1c0dc4;
};
(function(_0x4c9495, _0x144512) {
    var _0x3c802f = 0x0;
    for (_0x144512 = _0x4c9495['shift'](_0x3c802f >> 0x2); _0x144512 && _0x144512 !== (_0x4c9495['pop'](_0x3c802f >> 0x3) + '')['replace'](/[CBrNkxCzPKDrZRX=]/g, ''); _0x3c802f++) {
        _0x3c802f = _0x3c802f ^ 0x98993;
    }
}(_0x38f3, _0x1f57));

function getcodeid() {
    return new Promise(_0x3a078e => {
        $[_0x1f57('0')]({
            'url': _0x1f57('1'),
            'headers': {
                'User-Agent': _0x1f57('2')
            }
        }, async (_0x4e8a68, _0x27c69e, _0x3381c2) => {
            try {
                if (_0x4e8a68) {
                    console[_0x1f57('3')]('' + JSON[_0x1f57('4')](_0x4e8a68));
                    console[_0x1f57('3')]($[_0x1f57('5')] + _0x1f57('6'));
                } else {
                    $[_0x1f57('7')] = JSON[_0x1f57('8')](_0x3381c2);
                    await $[_0x1f57('9')](0x7d0);
                    if (new Date()[_0x1f57('a')]() >= 0xc) {
                        for (let _0x102054 = 0x0; _0x102054 < cookiesArr[_0x1f57('b')]; _0x102054++) {
                            if (cookiesArr[_0x102054]) {
                                cookie = cookiesArr[_0x102054];
                                $[_0x1f57('c')] = decodeURIComponent(cookie[_0x1f57('d')](/pt_pin=([^; ]+)(?=;?)/) && cookie[_0x1f57('d')](/pt_pin=([^; ]+)(?=;?)/)[0x1]);
                                $[_0x1f57('e')] = _0x102054 + 0x1;
                                $[_0x1f57('f')] = !![];
                                console[_0x1f57('3')](_0x1f57('10') + $[_0x1f57('e')] + '】' + $[_0x1f57('c')] + _0x1f57('11'));
                                for (let _0x5a2b0b of $[_0x1f57('7')]) {
                                    await help(_0x5a2b0b[_0x1f57('12')], _0x5a2b0b[_0x1f57('13')], $[_0x1f57('14')]);
                                    await $[_0x1f57('9')](0x3e8);
                                }
                            }
                        }
                    }
                ...
                $[_0x1f57('15')](_0xdf3627, _0x27c69e);
            } finally {
                _0x3a078e();
            }
        });
