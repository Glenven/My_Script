...
# 京东汽车旅程赛点兑换金豆
59 23 * * * node /scripts/jd_car_exchange.js >> /scripts/logs/jd_car_exchange.log 2>&1
# 签到领现金
...
# 愤怒的锦鲤
1 0,1 * * * node /scripts/jd_angryKoi.js >> /scripts/logs/jd_angryKoi.log 2>&1
# 签到领现金红包兑换
...
# 宠汪汪邀请助力与赛跑助力脚本
15 10,18,20 * * * node /scripts/jd_joy_run.js >> /scripts/logs/jd_joy_run.log 2>&1
# 宠汪汪积分兑换奖品验证脚本
...
# 升级赚京豆
15 9,21 * * * node /scripts/jd_MMdou.js >> /scripts/logs/jd_MMdou.log 2>&1
