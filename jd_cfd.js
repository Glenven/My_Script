...
`)
  ...
  $.InviteLists = []
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://raw.fastgit.org/h455257166/MyUpdateTeam/main/MyShareCodes/jd_cfd.json');
    $.InviteLists.push(...$.innerInviteList,...$.InviteList);
  }else{
